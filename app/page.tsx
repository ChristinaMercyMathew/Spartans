...
export default function Home() {
  ...
  const teamMembers = [
    ...
    { id: 20, name: "Damo", image: "/images/spartans/spartan-warrior-damo.png", sports: ["cricket", "football", "carrom", "table-tennis", "snooker", "badminton", "pickle-ball"] },
    ...
    { id: 23, name: "GP", image: "/images/spartans/spartan-warrior-gaurav-pandey.png", sports: ["football", "pickle-ball"] },
    { id: 24, name: "Gogulanadhan", image: "/images/spartans/spartan-warrior-gogulanadhan-m.png", sports: ["chess"] },
    { id: 25, name: "Hariharan", image: "/images/spartans/spartan-warrior-hariharan-bharathwaj.png", sports: [ "carrom", "table-tennis", "pickle-ball"] },
    { id: 26, name: "Johnson", image: "/images/spartans/spartan-warrior-johnson-thomas.png", sports: [ "football", "snooker", "badminton", "pickle-ball", "chess"] },
    { id: 27, name: "Karthikeyan", image: "/images/spartans/spartan-warrior-karthikeyan-k.png", sports: ["cricket", "football", "carrom", "table-tennis", "snooker", "badminton", "pickle-ball", "chess"] },
    { id: 28, name: "Krish", image: "/images/spartans/spartan-warrior-krish-prasanth.png", sports: ["table-tennis","pickle-ball"] },
    ...
    { id: 32, name: "Giresh", image: "/images/spartans/spartan-warrior-mohan-giresh.png", sports: ["football", "carrom", "table-tennis", "snooker", "badminton", "pickle-ball"] },
    { id: 33, name: "Nandakumar", image: "/images/spartans/spartan-warrior-nandakumar-m.png", sports: ["football", "carrom", "table-tennis", "badminton", "pickle-ball", "chess"] },
    { id: 34, name: "Prasanna", image: "/images/spartans/spartan-warrior-prasanna-venkatesh-bhupendran.png", sports: [] },
    { id: 35, name: "Rakesh", image: "/images/spartans/spartan-warrior-rakesh.png", sports: ["cricket", "football", "carrom", "table-tennis", "snooker", "badminton", "pickle-ball"] },
    ...
    { id: 39, name: "Vishnu", image: "/images/spartans/spartan-warrior-sri-vishnu-yarlagadda.png", sports: ["cricket", "table-tennis", "snooker", "badminton", "pickle-ball", "chess"] },
    { id: 40, name: "Srivatsan S", image: "/images/spartans/spartan-warrior-srivatsan-saravanan.png", sports: ["cricket", "football", "carrom", "table-tennis", "snooker", "badminton", "pickle-ball"] },
